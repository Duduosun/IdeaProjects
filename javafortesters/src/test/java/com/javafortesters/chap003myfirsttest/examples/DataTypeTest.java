...
/**
 * Created by Tola on 26/05/2015
 */
public class DataTypeTest {

    @Test
    public void BooleanType(){
        boolean mandeville = true;
        boolean watford = false;

        assertTrue(mandeville);
        assertFalse(watford);

        watford = Boolean.TRUE;
        mandeville = Boolean.FALSE;

        assertTrue(watford);
        assertFalse(mandeville);
    }
    ...
    @Test
    public void traditionalOperatorsExplained(){
        assertEquals(4,2+2);
    ...
    @Test
    public void incrementDecrementOperatoresExplained(){
        int num =10;
        assertEquals(11, ++num);
        assertEquals(10, --num);
        assertEquals(10, num++);
    ...
    @Test
    public void booleanOperatorsExplained(){
        assertTrue(4 == 4);
        assertTrue(4 !=5);
        assertTrue(3 < 4);
        assertTrue(5 > 4);
    ...
    public void ternaryOperatorsExplored(){
        int x;
        x=4>3 ? 2 : 1; //if 4>3 then return 2, else return 1
        assertEquals(2,x);
    ...
    @Test
    public void bitwiseOperatorsExplored(){     //1 True, 0 False
        assertEquals(0b0001, 0b1001 & 0b0101);  //and
        assertEquals(0b1101, 0b1001 | 0b0101);  //or
        assertEquals(0b1100, 0b1001 ^ 0b0101);  //xor - outputs when both differs

        int x = 0b0001;
        assertEquals("11111111111111111111111111111110", Integer.toBinaryString(~x)); //~ reverse
    }
